...
namespace TestProgrammer
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            buff = new byte[] { STK_SET_DEVICE, 0x86, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x03, 0xff, 0xff, 0xff, 0xff, 0x00, 0x80, 0x04, 0x00, 0x00, 0x00, 0x80, 0x00, CRC_EOP };
            ...
            // TODO: Determine purpose of code Segment
            buff = new byte[] { STK_SET_DEVICE_EXT, 0x05, 0x04, 0xd7, 0xc2, 0x00, CRC_EOP };
            ser.Write(buff, 0, buff.Length);
            Console.Write("Send:");
            for (int i = 0; i < buff.Length; i++)
            {
            ...
            // Enter Program mode (Actually does nothing for Optiboot)
            ...
            // TODO: Determine purpose of code Segment
            buff = new byte[] { STK_UNIVERSAL, 0xa0, 0x03, 0xfc, 0x00, CRC_EOP };
            ser.Write(buff, 0, buff.Length);
            Console.Write("Send:");
            for (int i = 0; i < buff.Length; i++)
            {
            ...
            // TODO: Determine purpose of code Segment
            buff = new byte[] { STK_UNIVERSAL, 0xa0, 0x03, 0xfd, 0x00, CRC_EOP };
            ser.Write(buff, 0, buff.Length);
            Console.Write("Send:");
            for (int i = 0; i < buff.Length; i++)
            {
            ...
            // TODO: Determine purpose of code Segment
            buff = new byte[] { STK_UNIVERSAL, 0xa0, 0x03, 0xfe, 0x00, CRC_EOP };
            ser.Write(buff, 0, buff.Length);
            Console.Write("Send:");
            for (int i = 0; i < buff.Length; i++)
            {
            ...
            // TODO: Determine purpose of code Segment
            buff = new byte[] { STK_UNIVERSAL, 0xa0, 0x03, 0xff, 0x00, CRC_EOP };
            ser.Write(buff, 0, buff.Length);
            Console.Write("Send:");
            for (int i = 0; i < buff.Length; i++)
            {
